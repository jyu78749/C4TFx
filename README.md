...
## Installation
Run quickinstall.sh and follow instructions, `docker build . --file Dockerfile --tag ccctfx-latest` (note that this uses MariaDB which is compatible with MySQL), or do the following:
